...
-- We consider ROUND(num, decim-places) used to round decimals to a certain decial place as specified.
SELECT
	genre,
    ROUND(
		AVG(rating),
...
ORDER BY STATUS;
-- OR, Notice the use of IF(cond, evalTrue, evalFalse) statement as against the use of case statement, only used in simple conditional statements
SELECT
	first_name,
    last_name,
    COUNT(rating) AS COUNT,
